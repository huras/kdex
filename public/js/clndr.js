...
(function (factory) {
        ...
        "<div class='clndr-controls'>" +
            ...
            "<div class='month-changers'> "+
                "<div class='clndr-control-button'>" +
                    "<span class='month-changer clndr-previous-button'><i class='fas fa-chevron-left'></i> </span>" +
                "</div>" +            
                "<div class='clndr-control-button rightalign'>" +
                    "<span class='month-changer clndr-next-button' style='transform:scaleX(-1);'><i class='fas fa-chevron-left'></i> </span>" +
                "</div>" +
            "</div>" +
        "</div>" +
    ...
    function Clndr(element, options) {
        ...
        // //Seta todos os eventos na variável de eventos do próprio clndr para ser recuperados na hora do clique
        // const url = ('http://'+window.location.host+'/agendax').toString();        
        // const self = this;        
        ...
        //         var eventStart = new Date(events[index].when_start.substring(0,4), Number(events[index].when_start.substring(5,7))-1, events[index].when_start.substring(8,10));
        //         var eventEnd = new Date(events[index].when_end.substring(0,4), Number(events[index].when_end.substring(5,7))-1, events[index].when_end.substring(8,10));
                
        //         if(eventStart <= today && today <= eventEnd){
        //             events[index].obs = events[index].intervalo_funcionamento;
        //             eventos.push(events[index]);                    
        //         }                
        //     }            
        ...
        //     showEventsOfTheDay(target);

        //     const formatedEvents = events.map(function(event){
        //         return {
        //             start: event.when_start.substring(0, 10),
        //             end: event.when_end.substring(0, 10),
        //             title : event.title,
        //             url : event.url,
        //             obs : event.intervalo_funcionamento
        //         }
        //     })
        //     self.setEvents(formatedEvents);
        // })
    }
